  ...
  return (
    <div className="p-8 flex flex-col gap-8 bg-gray-100">
      <h1 className="text-[40px] text-center font-bold">
        Let´s Hear Whath they says
      </h1>
      <div className="flex justify-center gap-4">
        <span>
          <ImQuotesLeft className="text-5xl text-primary" />
        </span>
        <p className="max-w-2xl text-center text-gray-500">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa, alias
          quibusdam a vitae fugit veritatis est tempora, debitis expedita hic
          dicta, aspernatur sunt commodi blanditiis? A doloribus corrupti quam
          quae?
        </p>
        <span>
          <ImQuotesRight className="text-5xl text-primary " />
        </span>
      </div>
